    ...
    <div className="w-full">
      ...
      <input
        ...
        className={twMerge(
          ...
          'dark:bg-slate-900 dark:border-slate-800 dark:text-white dark:placeholder-slate-500',
          error && 'border-red-300 focus:border-red-500 focus:ring-red-500/20 bg-red-50/10 dark:bg-red-900/10 dark:border-red-800',
          className
        )}
        {...props}
      />
